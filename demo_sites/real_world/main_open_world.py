...
def function(file_path: str):
    ...
    # name = ['chrome', 'AliyunNetdisk', 'BaiduNetdisk', 'bilibili', 'iQiYi', 'pr2023', 'qq_music', 'spotify', 'tencent_meeting',
    #         'wechat', 'zoom']
    ...
    name_file = ['baseline', 'AliyunNetdisk', 'BaiduNetdisk', 'bilibili', 'iQiYi',  'pr2023', 'qq_music', 'spotify', 'tencent_meeting', 'wechat', 'zoom']
    # model_name = ['chrome', 'AliyunNetdisk', 'BaiduNetdisk', 'bilibili', 'iQiYi', 'pr2023', 'qq_music', 'spotify', 'tencent_meeting', 'wechat', 'zoom']
    name = ['Chrome', 'Aliyun Netdisk', 'Baidu Netdisk', 'Bilibili', 'iQiYi', 'Premiere Pro', 'QQ music', 'Spotify', 'Tencent Meeting', 'WeChat', 'Zoom']
    label_list = [['Chrome'], ['Download', 'Upload', 'Watch video'], ['Download', 'Upload', 'Watch video'],
