...
def modelTrain(dataset_path_0, dataset_path_1, test_path):
    ...
    X_train_2, X_test_2, y_train_2, y_test_2 = train_test_split(X_2, y_2, test_size=0.2/15 * 10, random_state=42)
