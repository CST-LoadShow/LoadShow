from multi_application_recognition_RF_all.multi_app_recognition_n2.random_forest import modelTrain, modelTest
...
if __name__ == "__main__":
    ...
    file_test = "../../../dataset/multi_app_RF/9600k-2060-tri_label_v1"
