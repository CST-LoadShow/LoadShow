...
def resnet18_train(dataset_train, dataset_test, train_epoth, classes, flag=False, load_path='./model/model.pth'):
        ...
        if True:
            ...
            with torch.no_grad():
                ...
                if acc / len(val_dataloader) > max_acc:
                    ...
                    torch.save(model.state_dict(), './model/model_%d.pth' % epoch)
