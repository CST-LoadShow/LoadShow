...
from real_world_recognition.random_forest import modelTrain, modelTest
...
def getDate(file1, file2, software_name):
    ...
    data_np, labels = getCsvNpSoftware(file_label, file1, 64, size, feature_list, software_name, size_max=200)
...
if __name__ == "__main__":
    ...
    name = ['AliyunNetdisk', 'BaiduNetdisk', 'bilibili', 'iQiYi', 'pr2023', 'qq_music', 'spotify', 'tencent_meeting',
            'wechat', 'zoom']
    real_world_file = '../dataset/program-fp-data/real-world'
    save_file = "../dataset/program-fp-data/div_firstpeak/9600k-2060-behavior"
    input_file = []
    label_list = []
